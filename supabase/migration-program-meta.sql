...
alter table public.exercises add column if not exists equipment text;  -- Barbell, Dumbbells, Cable column, ...
alter table public.exercises add column if not exists alt       text;  -- hotel / no-free-weights alternative (e.g. Leg Press)
